...
class CategoryRepository extends BaseRepository
{
    ...
    {
        return $this->model->where('publish', 1)->where('is_room', 1)->whereNull('deleted_at')->get();
    }

    public function getCategory()
    {
        return $this->model->where('publish', 1)->where('is_room', 2)->whereNull('deleted_at')->get();
    }
    public function getParentCategory()
    {
        return $this->model->where('publish', 1)->where('is_room', 2)->whereNull('parent_id')->get();
    }
