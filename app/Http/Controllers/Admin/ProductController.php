...
public function show($slug)
{
    ...
    $product->load(['categories', 'productVariants', 'productVariants.productVariantAttributes']);

    $config = $this->config();
    $config['breadcrumb'] = [
        'name' => 'Chi tiết sản phẩm',
        'list' => ['QL sản phẩm', 'Chi tiết sản phẩm']
    ];

    return view('admin.pages.product.product.show', compact('config', 'product'));
}
