...
class CommentController extends Controller
{
    ...
    public function getComments(Request $request, $slug)
    {
        ...
        $count_comments = $post->comments->whereNull('parent_id')->count();
        return view('client.pages.post.components.comment', compact('post', 'comments', 'count_comments', 'count_comment_current'))->render();
    }
