...
class StoreDiscountCodeRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'max_usage.integer' => 'Số lượt sử dụng tối đa phải là số nguyên.',
            'max_usage.min' => 'Số lượt sử dụng tối đa phải lớn hơn hoặc bằng 0.',
            'used_count.integer' => 'Số lượt đã sử dụng phải là số nguyên.',
            'used_count.min' => 'Số lượt đã sử dụng phải lớn hơn hoặc bằng 0.',
            'is_unlimited.boolean' => 'Trường giới hạn lượt sử dụng phải là boolean.'
        ];
    }
}
