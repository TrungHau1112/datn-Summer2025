  ...
  <div class="section-box shop-template mt-30">
    ...
    <div class="row">
      ...
      <div class="text-center py-5">
        ...
        <p class="text-muted">Hãy thử tìm kiếm với bộ lọc khác hoặc <a href="{{ route('client.home') }}">về trang
        chủ</a></p>
      </div>
      </div>
      @endif
      ...
      <div class="sidebar-border mb-0">
        ...
        <ul class="list-nav-arrow">
          ...
          <a href="{{ route('client.product.index', array_filter(array_merge(request()->all(), [
        'brand_id' => $brand->id,
        'category_id' => null
        ]))) }}">
