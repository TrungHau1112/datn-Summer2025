    ...
    <div class="info-card p-4 shadow-sm rounded bg-white">
        ...
        <div class="">
            <ul class="nav nav-line-bottom mb-3" id="pills-tabOne" role="tablist">
                ...
                <li>
                    <a class="nav-link pt-0 order_status" id="delivery-failed-order-tab" data-status="delivery_failed"
                        data-url="{{ route('client.account.get-order-by-status', 'delivery_failed') }}" data-bs-toggle="pill"
                        href="#delivery-failed-order" role="tab" aria-controls="delivery-failed-order" aria-selected="false"
                        tabindex="-1">
                        Giao hàng thất bại
                    </a>
                </li>
