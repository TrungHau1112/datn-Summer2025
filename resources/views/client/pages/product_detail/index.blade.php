                            ...
                            <div class="pl-30 pl-mb-0">
                                ...
                                <div class="box-sidebar-product">
                                    <div class="banner-right h-500 text-center mb-30 banner-right-product"><span
                                            class="text-no font-11">Số 09</span>
                                        <h5 class="font-md-bold mt-10">Cảm ứng nhạy<br
                                                class="d-none d-lg-block">không có dấu vân tay
                                        </h5>
                                        <p class="text-desc font-xs mt-10">Tay cầm trơn tru và nhấp chuột chính xác</p>
                                    </div>
                                </div>
                            </div>
                        </div>
