                            ...
                            <div class="col-12">
                                @php
                                    $methods = [
                                        ...
                                        ['id' => 3, 'label' => 'Thanh toán bằng Momo', 'image' => 'https://itviec.com/rails/active_storage/representations/proxy/.../MoMo%20Logo.png', 'route' => route('client.checkout.momo.pay')],
                                    ];
                                @endphp
...
<div class="cart-discount d-flex my-5">
                    ...
                    <div class="shipping-calculation mb-3 p-3 border rounded bg-light">
                        ...
                        <div class="mb-3">
                            <button type="button" class="btn btn-primary btn-sm w-100" id="calculateShippingFee">
