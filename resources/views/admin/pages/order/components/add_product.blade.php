<div class="filterProduct">
    ...
    <div class="form-group mb-3">
        <label for="total">Tổng tiền: <strong class="total_amount" id="preview_totle">0</strong></label>
        <input type="hidden" id="total" name="total" class="form-control" value="0" required>
        <input type="hidden" id="cart" name="cart" class="form-control" value="[]" required>
    </div>
