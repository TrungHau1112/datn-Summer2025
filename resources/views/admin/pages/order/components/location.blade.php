<div class="row mb-3">
    <div class="col-4 form-group">
        ...
        <select name="province_id" id="province" class="form-control province select2_order location" data-target="districts" required>
    ...
    <div class="col-4 form-group">
        ...
        <select name="district_id" id="district" class="form-control select2_order districts location" data-target="wards" required>
    ...
    <div class="col-4 form-group">
        ...
        <select name="ward_id" id="ward" class="form-control select2_order wards" required>
