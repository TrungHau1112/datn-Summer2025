                    ...
                    if (categoryItems.length > 0) {
                        ...
                        $.each(categoryItems, function (_, item) {
                            $searchCategory.append(`
                                <a href="/danh-muc/${item.slug}" class="badge bg-light text-dark me-2 mb-2 text-decoration-none">
                                    ${item.name}
                                </a>
                            `);
                        });
                    ...
                    if (!resultsFound) {
                        $searchResult.html(`
                            <div class="text-center py-4">
                                ...
                                <a href="/tim-kiem?keyword=${encodeURIComponent(searchValue)}" class="btn btn-sm btn-primary">
                                    Xem tất cả kết quả
                                </a>
                            </div>
                        `);
