(function ($) {
    ...
    TGNT.renderRow = (product) => {
        if (product) {
            ...
            $("#product-table-body").append(`   
                ...
                `);
            TGNT.deleteProduct();
            // Tự động tính lại tổng tiền sau khi thêm sản phẩm
            setTimeout(function() {
                TGNT.calculateTotalAmount();
            }, 100);
        }
    ...
    TGNT.calculateTotalAmount = () => {
        ...
        $("#product-table-body tr").each(function () {
            ...
            let name = $(this).find('input[name="name_orderDetail[]"]').val();
        ...
        $("#cart").val(JSON.stringify(cartData));
    ...
    $(document).ready(function () {
        ...
        // Đảm bảo tính toán lại khi submit form
        $('form').on('submit', function(e) {
            TGNT.calculateTotalAmount();
            
            // Debug: Kiểm tra giá trị trước khi submit
            console.log('Total value:', $("#total").val());
            console.log('Cart value:', $("#cart").val());
            console.log('Array idArray:', array.idArray);
            ...
            // Đảm bảo total không phải 0
            let totalValue = parseInt($("#total").val()) || 0;
            if (totalValue <= 0) {
                e.preventDefault();
            ...
            // Debug: Log form data
            console.log('Form is being submitted with valid data');
        });
    });
})(jQuery);
